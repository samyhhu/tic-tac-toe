...
contract TicTacToe {
    ...
    function victory(uint16 state) private returns(bool) {
      return (
        state == 448    //= 2**8 + 2**7 + 2**6 = 111 000 000
        || state == 56  //= 2**5 + 2**4 + 2**3 = 000 111 000
        || state == 7   //= 2**2 + 2**1 + 2**0 = 000 000 111
        || state == 292 //= 2**8 + 2**5 + 2**2 = 100 100 100
        || state == 146 //= 2**7 + 2**4 + 2**1 = 010 010 010
        || state == 73  //= 2**6 + 2**3 + 2**0 = 001 001 001
        || state == 273 //= 2**8 + 2**4 + 2**0 = 100 010 001
        || state == 84  //= 2**6 + 2**4 + 2**2 = 001 010 100
      );
    }
